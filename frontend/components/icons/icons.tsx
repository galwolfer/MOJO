...
function decodeBase64(base64: string) {
  ...
  if (typeof nodeBuffer !== "undefined") return nodeBuffer.from(base64, "base64").toString("utf8");
...
function encodeBase64(str: string) {
  ...
  const nodeBuffer = (globalThis as any).Buffer;
  if (typeof nodeBuffer !== "undefined") return nodeBuffer.from(str, "utf8").toString("base64");
