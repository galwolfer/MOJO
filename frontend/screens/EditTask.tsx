...
const EditTask: React.FC<{ taskId?: string }> = ({ taskId = "" }) => {
  ...
  // Hide the NavigationContext header since EditTask has its own built-in header
  useEffect(() => {
    setHeaderConfig({
      show: false,
    });
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.headerContent}>
          ...
          <Pressable
            ...
            onPress={() => {
              ...
              Alert.alert(
                "Discard Changes?",
                "Are you sure you don't want to edit the task?",
                [
                  {
                    text: "Stay",
                    onPress: () => {
                      // Stay on EditTask page - do nothing
                    },
                    style: "cancel",
                  },
                  {
      ...
      <ScrollView
        ...
        scrollIndicatorInsets={{ top: headerHeight, bottom: NAVBAR_HEIGHT }}
      >
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    padding: SPACING.md,
    paddingBottom: NAVBAR_HEIGHT + SPACING.md,
  },
  headerSection: {
    position: "absolute",
    top: 0,
