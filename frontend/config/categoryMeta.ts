...
export const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  reflection: { icon: "reflection", color: COLORS.brightP6, displayName: DISPLAY_NAMES.reflection },
  home_and_chores: { icon: "home", color: COLORS.primary5, displayName: DISPLAY_NAMES.home_and_chores },
  family: { icon: "family", color: COLORS.primary6, displayName: DISPLAY_NAMES.family },
  life_management: { icon: "list", color: COLORS.brightP1, displayName: DISPLAY_NAMES.life_management },
  work_and_career: { icon: "work", color: COLORS.darkP1, displayName: DISPLAY_NAMES.work_and_career },
  creative_projects: { icon: "creative", color: COLORS.primary4, displayName: DISPLAY_NAMES.creative_projects },
  hobbies: { icon: "hobbies", color: COLORS.brightP3, displayName: DISPLAY_NAMES.hobbies },
  relationship: { icon: "heart", color: COLORS.primary4, displayName: DISPLAY_NAMES.relationship },
  goals: { icon: "goals", color: COLORS.primary5, displayName: DISPLAY_NAMES.goals },
  ...
  social_activity: { icon: "friends", color: COLORS.primary3, displayName: DISPLAY_NAMES.social_activity },
  recovery: { icon: "repeat", color: COLORS.brightP6, displayName: DISPLAY_NAMES.recovery },
  exploration: { icon: "explore", color: COLORS.brightP2, displayName: DISPLAY_NAMES.exploration },
